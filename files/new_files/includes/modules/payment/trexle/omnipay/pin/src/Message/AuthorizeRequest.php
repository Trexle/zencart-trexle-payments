 ...
 * $gateway = Omnipay::create('TrexleGateway');
 *
 ...
 * @link https://docs.trexle.comcharges
 */
class AuthorizeRequest extends PurchaseRequest
{
     ...
     * and not a boolean or Trexle's API will disregard it and consider it set
     * to 'true'
     *
    ...
    public function getCapture()
    {
        ...
        // By default with Trexle a transaction is captured.
